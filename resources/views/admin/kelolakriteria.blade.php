            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="col-auto" style="margin-bottom:30px;">
                        <button class=" btn btn-success" data-bs-toggle="modal" data-bs-target="#tambahPengguna">Tambah Kriteria</button>
                    </div>
                            ...
                            <div class="modal-content">
                                ...
                                <form action="{{ route('admin.kelolakriteria.tambah') }}" method="post" enctype="multipart/form-data">>
                                    ...
                                    <div class="modal-body">
                                        <div class="row mb-3">
                                            <label for="inputEmail3" class="col-sm-4 col-form-label">Nama Kriteria</label>
                                            <div class="col-sm-8">
                                        ...
                                        <div class="row mb-3">
                                            <label for="inputEmail3" class="col-sm-4 col-form-label">Jenis Kriteria</label>
                                            <div class="col-sm-8">
