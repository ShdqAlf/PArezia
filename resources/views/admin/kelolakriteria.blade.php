                        ...
                        <div class="modal fade" id="tambahPengguna" tabindex="-1">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <form action="{{ route('admin.kelolakriteria.tambah') }}" method="post"
                                        ...
                                        <div class="modal-body">
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control" name="nama_kriteria"
                                                        placeholder="Tambahkan Kriteria">
                                                </div>
                                            </div>
                                            <div class="row mb-3">
                                                <label for="inputEmail3" class="col-sm-4 col-form-label">Kode Bobot</label>
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control" name="kode_bobot"
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control" name="nilai_bobot"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    ...
                                                    <form
                                                        action="{{ route('admin.kelolakriteria.hapus-kriteria', $row->id) }}"
