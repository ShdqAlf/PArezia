                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="modal fade" id="tambahPengguna" tabindex="-1">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <form action="{{ route('admin.kelolaloker.tambah-loker') }}" method="post"
                        ...
                        <div class="table-responsive">
                            <table id="kelolaloker" class="display" style="width:100%">
                                <thead>
                                    <tr>
                                        <th>No</th>
                                        <th>Judul</th>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    ...
                                                    <form action="{{ route('admin.kelolaloker.hapus-loker', $row->id) }}"
                    ...
                    <form action="{{ route('admin.kelolaloker.edit', $row) }}" method="POST">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="role" name="pendidikan">
                                    <option value="SD/Sederajat"
                                        {{ $row->minimal_pendidikan == 'SD/Sederajat' ? 'selected' : '' }}>SD/Sederajat
                                    </option>
                                    <option value="SMP/Sederajat"
                                        {{ $row->minimal_pendidikan == 'SMP/Sederajat' ? 'selected' : '' }}>SMP/Sederajat
                                    </option>
                                    <option value="SMA/Sederajat"
                                        {{ $row->minimal_pendidikan == 'SMA/Sederajat' ? 'selected' : '' }}>SMA/Sederajat
                                    </option>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="pengalaman"
                                    value="{{ $row->minimal_pengalaman }}">
                            </div>
                            <div class="mb-3">
                                <label for="usia_maks" class="form-label">Usia Maksimal</label>
                                <input type="text" class="form-control" name="usia_maks"
                                    value="{{ $row->usia_maks }}">
                            </div>
                            <div class="mb-3">
