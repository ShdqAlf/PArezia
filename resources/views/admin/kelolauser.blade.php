            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table id="kelolauser" class="table table-bordered" style="width:100%">
                            <thead>
                                <tr>
                                    <th>No</th>
                                    <th>Email</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <button class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#hapusModal{{ $user->id }}">Hapus</button>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
...
<div class="modal fade" id="hapusModal{{ $user->id }}" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Yakin ingin menghapus pengguna dengan email <b>{{ $user->email }}</b>?</p>
            </div>
            <div class="modal-footer">
