                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <a class="btn btn-success mt-2 mb-2" data-bs-toggle="modal" data-bs-target="#diterimaModal{{ $item->id }}">
                                                    <i data-feather="check-circle" width="20"></i>
                                                </a>
                                                <a href="" class="btn btn-danger mt-2 mb-2" data-bs-toggle="modal" data-bs-target="#ditolakModal{{ $item->id }}">
                                                    <i data-feather="x-circle" width="20"></i>
                                                </a>
                                                @else
                                                @if ($item->status_tes == 'Diterima')
                                                <span class="bg-success rounded text-white p-2 mt-3 mb-3">{{ $item->status_tes }}</span>
                                                @elseif($item->status_tes == 'Ditolak')
                                                <span class="bg-danger rounded text-white p-2 mt-3 mb-3">{{ $item->status_tes }}</span>
                                                @endif
                                                @endif
                                            </td>
                                        </tr>
