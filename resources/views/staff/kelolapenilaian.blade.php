                    ...
                    <table id="penilaian_pelamar" class="table table-responsive table-bordered" style="width:100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    @if (!is_null($item->penilaian) && $item->penilaian->exists())
                                    <button class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#editModal{{ $item->id }}">
                                        <i data-feather="edit-3" width="20"></i>
                                        Edit
                                    </button>
                                    @else
                                    <button class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#tambahModal{{ $item->id }}">
            ...
            <form action="{{ route('staff.kelolapenilaian.tambah') }}" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="email" name="nilai_{{ $row->id }}" placeholder="Masukkan Nilai {{ $row->kode_bobot }}">
                    </div>
                    @endforeach
                </div>
