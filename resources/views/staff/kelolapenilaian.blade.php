            ...
            <table id="kelola_penilaian" class="table table-responsive table-bordered" style="width:100%">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td></td>
                        <td>
                            <button class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#tambahModal{{ $pelamar->user->id }}">Tambah</button>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
            ...
            <table id="kelola_penilaian" class="table table-responsive table-bordered" style="width:100%">
                <thead>
                    <tr class="bg-secondary text-white">
                        ...
                        <th>{{ $nilai->kriteria->kode_bobot }}</th>
                        @endforeach
                    </tr>
                </thead>
                <tbody>
...
<div class="modal fade" id="tambahModal{{ $pelamar->user->id }}" tabindex="-1">
